...
import { RafCoalescer } from "./ConsumerOptGraphViewRafCoalescer";
import { exportSvgElement } from "./svgExport";
...
type PlotOffset = { x: number; y: number };
...
export class ConsumerOptGraphView extends React.Component<Props, State> {
  ...
  private readonly svgMargin: typeof SVG_MARGIN;
