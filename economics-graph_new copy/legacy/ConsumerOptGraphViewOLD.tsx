...
import { AxesView } from "../src/MVC/view/AxesView";

// SvgSceneView：renderer，把 SceneOutput.drawables 畫成 SVG 元素
import { SvgSceneView } from "../src/MVC/view/SvgSceneView";

// SceneOutput：這張圖的「唯一渲染輸入」
// 內含 drawables + xDomain/yDomain + width/height
import type { SceneOutput } from "../src/core/drawables";

// Controller：GraphView 需要一個 controller 來取得 scene、訂閱更新、轉交拖曳事件
import { ConsumerOptController } from "../src/MVC/controller/ConsumerOptController";

// GraphView: GraphView 的 state 也保存 viewport
import { Viewport } from "../src/core/Viewport";

import type { TickVisibility } from "../src/MVC/view/axesTicks";

import { SVG_HEIGHT, SVG_MARGIN, SVG_WIDTH } from "../src/core/layout";
